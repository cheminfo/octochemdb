...
const importOneSubstanceFile = require('./utils/importOneSubstanceFile');

const debug = require('debug')('incrementalSubstanceImport');
...
module.exports = incrementalSubstanceImport;
