...
export async function sync(connection) {
  ...
  const options = {
    ...
    destinationLocal: `data/originalData/bioassays/full`,
  ...
  try {
    ...
    if (process.env.NODE_ENV === 'test') {
      bioactivitiesFile = `src/plugins/bioassays/sync/utils/__tests__/data/bioactivities.tsv.gz`;
      bioassaysFile = `src/plugins/bioassays/sync/utils/__tests__/data/bioassays.tsv.gz`;
      ...
      sources = [
        bioassaysFile.replace(`data/originalData/`, ''),
        bioactivitiesFile.replace(`data/originalData/`, ''),
      ];
    }
