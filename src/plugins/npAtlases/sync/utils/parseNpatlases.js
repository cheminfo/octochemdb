 ...
 * @param json - Array of NPAtlas compound objects
  ...
  try {
    for await (const entry of json) {
      try {
        ...
        /** @type {NpAtlasTaxon} */
        const taxon = {
          genusID: taxonomies.taxon.ncbi_id,
          genus: taxonomies.genus,
          species: taxonomies.genus.concat(' ', taxonomies.species),
        };
