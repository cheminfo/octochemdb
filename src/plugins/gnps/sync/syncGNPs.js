...
export async function sync(connection) {
  try {
    ...
    const options = {
      ...
      destinationLocal: `data/originalData/gnps/full`,
      collectionName: 'gnps',
    ...
    if (process.env.NODE_ENV === 'test') {
      lastFile = `src/plugins/gnps/sync/utils/__tests__/data/gnpsTest.json`;
      sources = ['src/plugins/gnps/sync/utils/__tests__/data/gnpsTest.json'];
    } else {
