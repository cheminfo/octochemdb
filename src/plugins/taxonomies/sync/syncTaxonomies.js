...
export async function sync(connection) {
  const options = {
    ...
    destinationLocal: `data/originalData/taxonomies/full`,
  ...
  try {
    ...
    if (process.env.NODE_ENV === 'test') {
      lastFile = `src/plugins/taxonomies/sync/utils/__tests__/data/new_taxdump.zip`;
      sources = [
        `src/plugins/taxonomies/sync/utils/__tests__/data/new_taxdump.zip`,
      ];
    } else {
