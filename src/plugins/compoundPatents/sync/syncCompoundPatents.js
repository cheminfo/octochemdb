 ...
 * @async
 * @param connection - An active OctoChemConnection instance.
 * @returns
 */
export async function sync(connection) {
  ...
  try {
    const options = {
      ...
      destinationLocal: `data/originalData/compoundPatents/cidToPatents`,
    ...
    if (process.env.NODE_ENV === 'test') {
      lastFile = `src/plugins/compoundPatents/sync/utils/__tests__/data/patentsTest.gz`;
      sources = [lastFile];
    }
