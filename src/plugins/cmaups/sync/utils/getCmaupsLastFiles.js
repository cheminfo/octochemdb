 ...
 * @param connection - Active database connection wrapper used
...
export default async function getCmaupsLastFiles(connection) {
  try {
    ...
    if (process.env.NODE_ENV === 'test') {
      lastFileGeneral = `src/plugins/cmaups/sync/utils/__tests__/data/Ingredients.2023-10-23.txt`;
      lastFileActivity = `src/plugins/cmaups/sync/utils/__tests__/data/Activity.2023-10-23.txt`;
      lastFileSpeciesAssociation = `src/plugins/cmaups/sync/utils/__tests__/data/speciesAssociation.2023-10-23.txt`;
      lastFileSpeciesInfo = `src/plugins/cmaups/sync/utils/__tests__/data/speciesInfo.2023-10-23.txt`;
      lastTargetInfo = `src/plugins/cmaups/sync/utils/__tests__/data/targetAssociation.2023-10-23.txt`;
      sources = [
        lastFileGeneral,
        lastFileActivity,
      ...
      const options = {
        ...
        destinationLocal: `data/originalData/cmaups/full`,
      ...
      sources = [
        lastFileGeneral.replace(`data/originalData/`, ''),
        lastFileActivity.replace(`data/originalData/`, ''),
        lastFileSpeciesAssociation.replace(`data/originalData/`, ''),
