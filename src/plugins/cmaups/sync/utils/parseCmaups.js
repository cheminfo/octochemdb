 ...
 * @param general - Parsed rows from the Ingredients file.
 * @param activities - Map of ingredient ID → activity rows from the Activity file.
 * @param speciesPair - Species-association pairs (columns: Plant_ID, Ingredient_ID).
 * @param speciesInfo - Map of Plant_ID → species-info row from the Plants file.
 * @param targetInfo - Map of Target_ID → target-info row from the Targets file.
