 ...
 * output array.
 * @param entry - The CMAUP entry whose `data.activities` array is
 ...
 * @param taxonomiesCollection - Live MongoDB collection
 *   used by `searchTaxonomies()` to resolve `targetId` to taxonomy metadata.
 * @param oldToNewTaxIDs - Map of deprecated taxonomy IDs
