 ...
 * @param {Progress} progress - Mutable progress document; `seq` and
 *   `sources` are updated in place.
 * @param {{ name: string; path: string }} file - File descriptor to import.
 * @param {{ shouldImport: boolean; lastDocument: object }} options -
 *   Resume context.
 ...
 * @returns {Promise<number | undefined>} Number of articles imported, or
